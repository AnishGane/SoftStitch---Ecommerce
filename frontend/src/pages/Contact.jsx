  ...
  return <div>
    ...
    <div className="my-10 flex flex-col md:flex-row gap-10 justify-center mb-28">
      ...
      <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600 items-start">
        ...
        <p className="text-gray-500">Suryabinayak-8, Bhaktapur <br /> Near Suryabinayak Temple <br /> Kathmandu Valley, Nepal</p>
        <p className="text-gray-500">Opening Hours: <br /> Monday - Saturday: 10:00 AM - 8:00 PM <br /> Sunday: 11:00 AM - 6:00 PM</p>
        <p className="text-gray-500 mt-2">Email: info@fashionstore.com <br /> Phone: +977-123456789</p>
